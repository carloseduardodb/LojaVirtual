    ...
    <div class="tabela col-8">
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td><%=pd.getPreco()%></td>
                <td>
                    <button class="acao btn" onclick="location.href ='backpages/produtos/model.jsp?acao=editar&id-produto=<%=pd.getId_produto()%>'" ><img src="img/editar.png" width="15px" height="15px"></button>
